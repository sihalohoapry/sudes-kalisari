...
<body>
	<center>
		...
		<table width="625">
			<tr>
				<font  size="3"><b><u>SURAT KETERANGAN DOMISILI</u></b>
		...
		<table width="625">
			<tr>
		       <td>
			       <font size="2">Yang bertanda tangan dibawah ini Kepala Desa Kali Sari Kecamatan Natar Kabupaten Lampung Selatan menerangkan bahwa</font>
		       </td>
		    </tr>
		</table>
		<br>
		...
		<table width="625">
			...
			<tr class="text2">
				<td>Warga Negara</td>
				<td width="450">: <b>{{ $data->citizen }}</b></td>
			</tr>
			<tr class="text2">

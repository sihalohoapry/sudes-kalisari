...
<body>
	<center>
		...
		<br>
		@if($data->status_marry == 'Menikah')  
		<table width="625">
			<tr>
		       <td>
			       <font size="2">Bahwa nama tersebut diatas  <b><u>telah menikah</u></b> dengan : </font>
		       </td>
		    </tr>
		</table>
		<br>
		<table width="625">
			<tr class="text2">
				<td>Nama</td>
				<td width="450">: <b>{{ $data->name_marry }}</b></td>
			</tr>
			<tr class="text2">
				<td>Tempat, Tanggal Lahir</td>
				<td width="450">: <b>{{ $data->place_of_born_marry }}, {{$data->born_marry}}</b></td>
			</tr>
			<tr class="text2">
				<td>Jenis Kelamin</td>
				<td width="450">: <b>{{ $data->gander_marry }}</b></td>
			</tr>
			<tr class="text2">
				<td>Pekerjaan</td>
				<td width="450">: <b>{{ $data->job_marry }}</b></td>
			</tr>
			
			<tr class="text2">
				<td>Agama</td>
				<td width="450">: <b>{{ $data->religion_marry }}</b></td>
			</tr>
			<tr class="text2">
				<td>NIK</td>
				<td width="450">: <b>{{ $data->nik_marry }}</b></td>
			</tr>
			<tr class="text2">
				<td>Alamat</td>
				<td width="450">: <b>{{ $data->address_marry }}</b></td>
			</tr>
		...
		<table width="625">
			<tr>
		       <td>
			       <font size="2">Bahwa nama tersebut diatas  <b><u>belum menikah</u></b> </font>
		       </td>
		    </tr>
		</table>
		@endif
		...
		<table width="625">
			<tr>
		       <td>
			       <font size="2">Demikian surat keterangan ini dibuat dengan sebenarnya, kepada yang bersangkutan untuk dapat digunakan seperlunya.
</font>
		       </td>
		    </tr>
		</table>

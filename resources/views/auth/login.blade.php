...
<div class="page-content page-auth mt-5">
    <div class="section-store-auth" data-aos="fade-up">
        <div class="container">
            <h1 class="text-center mt-0">Sistem Informasi Penduduk <br> Kantor Desa Kalisari <br> Kabupaten Lampung
                Selatan</h1>
            <div class="row align-items-center row-login">
                <div class="col-lg-6 text-center">
                    <img src="images/logo_lampung_selatan.png" class="w-50 mb-4 mb-lg-none" alt="" />
                </div>
                <div class="col-lg-5">
                    <h2>
                        Silahkan Login
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-3">
                        ...
                        <button class="btn btn-success btn-block w-75 mt-5" type="submit"> Masuk</button>
